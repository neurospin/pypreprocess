...
MAINTAINER_EMAIL = 'elvis.dohmatob@inria.fr'
URL = 'http://pypreprocess.github.io'
LICENSE = 'new BSD'
DOWNLOAD_URL = 'http://pypreprocess.github.io'
...
if __name__ == "__main__":
    if is_installing():
        ...
        module_check_fn(is_pypreprocess_installing=True)
    ...
    setup(name=DISTNAME,
          ...
          # package_data={'pypreprocess.datasets.data': ['*.nii.gz', '*.csv'],
          #               'pypreprocess.plotting.glass_brain_files': ['*.json'],
          #               'pypreprocess.tests.data': ['*'],
          #               'pypreprocess.image.tests.data': ['*.mgz'],
          #               'pypreprocess.datasets.tests.data': ['*.*'],
          #               'pypreprocess.datasets.description': ['*.rst']},

...
if [[ "$DISTRIB" == "neurodebian" ]]; then
    ...
    sudo apt-get install -qq python-scipy python-nose python-nibabel python-sklearn python-sympy python-networkx python-sympy python-nipy python-sympy python-nipype

...
from coreutils.io_utils import (load_4D_img,
                                load_vol
                                )
...
def execute_spm_multimodal_fmri_glm(data, reg_motion=False):
    ...
    base_reporter.ProgressReport().finish(data['stats_report_filename'])
...
if __name__ == '__main__':
    ...
    def _pipeline_runner(subject_data, output_dir, execute_glm):
        ...
        for (subject_data, do_stc, do_realign, reg_motion, fwhm,
             output_dir_basename) in pipeline_factory(subject_data,
                                                            output_dir):
            ...
            preproc_output['output_dir'] = os.path.join(
                preproc_output['output_dir'], output_dir_basename)
